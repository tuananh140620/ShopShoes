...
<html lang="en">
    ...
    <body>
        <div class="container">
            ...
            <div 
                style="background-image: url(https://rubee.com.vn/admin/webroot/upload/image/images/nike-logo.jpg);
                        ...
                        <form action="edit" method="post">
                            ...
                            <div class="modal-body">					
                                <div class="form-group">
                                    <label>ID</label>
                                    <input value="${detail.id}" name="id" type="text" class="form-control" readonly required><%--ko thay doi id --%>
                                </div>
                                <div class="form-group">
                                    <label>Name</label>
